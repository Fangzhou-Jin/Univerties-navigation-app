                ...
                <div id="registerForm">
                    <form id="registerFormElement" class="space-y-4">
                        ...
                        <div class="space-y-1.5">
                            <label for="reg_username" class="text-xs font-medium text-slate-200">
                                Username
                            </label>
                            <input
                                id="reg_username"
                        ...
                        <div class="space-y-1.5">
                            <label for="reg_password_confirmation" class="text-xs font-medium text-slate-200">
                                Confirm Password
                            </label>
                            <input
                    ...
                    <p class="mt-5 text-[11px] text-center text-slate-300">
                        ...
                        <a href="{{ url('/users/login') }}" class="font-medium text-unaPrimary hover:text-cyan-300">
                            Sign in
                        </a>
                    </p>
                </div>
    ...
    <script>
        ...
        document.getElementById('registerFormElement').addEventListener('submit', async function(e) {
            ...
            try {
                ...
                if (result.status === 'need_ga_setup') {
                    // Store user ID for verification
                    currentUserId = result.user_id;
                    
                    // Hide registration form, show GA setup
                    ...
                    // Generate QR code
                    document.getElementById('gaQRCode').src = result.qr_code_url;
                    
                    showMessage('Account created! Please setup Google Authenticator to complete registration.', 'success');
                } else {
        ...
        // Step 2: GA verification and complete registration
        document.getElementById('gaVerifyFormElement').addEventListener('submit', async function(e) {
            ...
            try {
                ...
                if (result.status === 'success') {
                    ...
                    showMessage('Verification failed: ' + (result.message || 'Invalid code'), 'error');
                }
            } catch (error) {
