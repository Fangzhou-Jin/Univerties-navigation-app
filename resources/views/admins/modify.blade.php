...
<head>
    ...
    <style>
        ...
        /* THEME MODES (sync with Admin Home via localStorage 'una-dark') */
        body.dark-mode {
        ...
        body.light-mode {
            background: radial-gradient(circle at bottom right, #c4f1ff 0, transparent 55%), #f4f9f9 !important;
        ...
        /* Main area card-like surfaces (anything using bg-white/5 or bg-white/10) */
        ...
        /* Small labels / pills remain soft but visible */
        body.light-mode .bg-blue-500\/20 { background-color: #dbeafe !important; color:#1d4ed8 !important; }
        body.light-mode .bg-green-500\/20 { background-color: #dcfce7 !important; color:#15803d !important; }
        body.light-mode .bg-purple-500\/20 { background-color: #ede9fe !important; color:#6d28d9 !important; }
        body.light-mode .bg-orange-500\/20 { background-color: #ffedd5 !important; color:#c2410c !important; }
        body.light-mode .bg-red-600\/20 { background-color: #fee2e2 !important; color:#b91c1c !important; }

        /* Tables/rows hover in light mode */
        body.light-mode tr.hover\:bg-white\/5:hover {
            background-color: #f3f4f6 !important;
        }

        /* ===== Modal base styles (unchanged) ===== */
        .modal {
            display: none;
            position: fixed;
            z-index: 1000;
        ...
        /* Make all modals look like cards in light mode too */
        ...
        /* ==== Bottom sidebar buttons: Back to Home + Logout (LIGHT MODE VISIBILITY) ==== */
        body.light-mode #sidebarBottom a,
        body.light-mode #sidebarBottom a i {
            color: #0f172a !important;
            font-weight: 600;
        ...
        body.light-mode #sidebarBottom a:hover {
            background-color: #d4e4ff !important;
        }

        body.light-mode #sidebarBottom button,
        body.light-mode #sidebarBottom button i {
        ...
        body.light-mode #sidebarBottom button:hover {
...
<body class="bg-unaBgDark text-slate-50 min-h-screen flex">
    ...
    <aside class="relative z-20 w-64 bg-white/5 backdrop-blur-md border-r border-white/10 p-6 flex flex-col">
        ...
        <!-- BOTTOM SECTION -->
        <div id="sidebarBottom" class="mt-auto space-y-3">
                    ...
                    <table class="w-full text-sm">
                        <thead>
                            <tr class="border-b border-white/10 text-left">
                                ...
                                <th class="py-3 px-2">Directions</th>
                                <th class="py-3 px-2 text-right">Actions</th>
                            </tr>
                        </thead>
        ...
        <div class="modal-content bg-white/5 backdrop-blur-md p-8 rounded-xl border border-white/10 w-full max-w-md mx-4">
            ...
            <form id="room-form" onsubmit="saveRoom(event)">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        <label class="block text-sm text-slate-400 mb-2">Directions *</label>
                        <input type="text" id="room-directions" required placeholder="Enter room directions" class="w-full px-4 py-2 bg-white/5 border border-white/10 rounded-lg text-white placeholder-slate-400 focus:outline-none focus:border-unaPrimary">
                    </div>
                </div>
                <div class="mt-6 flex gap-3">
                    <button type="submit" class="flex-1 px-4 py-2 bg-unaPrimary hover:bg-unaPrimaryDark rounded-lg font-semibold transition-all">
    ...
    <!-- JAVASCRIPT -->
    <script>
        // Sync theme with Admin Home (localStorage key 'una-dark')
        (function syncTheme() {
            const isDark = localStorage.getItem('una-dark') === '1';
        ...
        function openEditModal(type, id) {
            ...
            if (type === 'user') {
                ...
                if (room) {
                    ...
                    document.getElementById('room-directions').value = room.directions_una || '';
                }
            }
        }
        ...
        async function loadRooms() {
            try {
                ...
                document.getElementById('rooms-table-body').innerHTML = `
                    <tr><td colspan="8" class="py-8 text-center text-red-400">
                        <i class="fa-solid fa-exclamation-triangle text-3xl mb-2"></i>
                        <p>加载失败</p>
                    </td></tr>`;
            }
        ...
        async function saveRoom(event) {
            ...
            const data = {
                ...
                directions_una: document.getElementById('room-directions').value
            };
