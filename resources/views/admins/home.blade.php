...
<head>
  ...
  <title>Universities Navigation Application (UNA) - Admin</title>
  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    /* Dark mode: make helper text more visible in Building / Floor boxes */
  ...
  <div class="row g-0">
    ...
    <main class="col-md-9 col-lg-10 p-4">
      ...
      <div class="d-flex flex-wrap justify-content-between align-items-center mb-3">
        <div>
          <h2 class="main-header-title mb-0">Universities Navigation Application - Admin</h2>
        ...
        <div class="mt-3 mt-md-0">
          <div class="dropdown">
            <button
              ...
              aria-expanded="false"
            >
              <span class="profile-avatar">{{ $user ? strtoupper(substr($user->username_una, 0, 1)) : 'A' }}</span>
            ...
            <ul class="dropdown-menu dropdown-menu-end shadow" aria-labelledby="profileMenuButton">
              ...
              <li class="dropdown-header small">
                  <div class="fw-semibold">{{ $user ? $user->username_una : 'Admin Account' }}</div>
                  <div class="text-muted">{{ $user ? $user->email_una : 'admin@example.com' }}</div>
              </li>
              ...
              <li>
                  <a class="dropdown-item" href="{{ url('/admins/profile') }}">
                      <i class="fa-solid fa-user me-2"></i>
                      My Profile
                  </a>
              </li>

              <!-- Modify Data - links to admins/modify -->
              <li>
                  <a class="dropdown-item" href="{{ url('/admins/modify') }}">
